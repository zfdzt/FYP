...
void CChart::DrawGridLabel(CDC *pDC)
{
	...
	cal_pt.x = m_ctlRect.CenterPoint().x + (txtSize.cx/2) + 30;
	cal_pt.y = m_ctlRect.bottom - txtSize.cy - 5; //横坐标与label间距
